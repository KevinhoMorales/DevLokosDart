...
def generate_android_icons():
    ...
    desde el ícono base de 1024x1024.
    """
    ...
    # Ruta del ícono base
    base_icon_path = "assets/icons/app_icon.png"
    ...
    try:
        ...
        print(f"\n🎉 Todos los íconos de Android generados exitosamente!")
        print("📱 Los íconos ahora tienen fondo negro completo")
